...
void MainWindow::on_tab_hebergement_activated(const QModelIndex &index)
{
    QSqlQuery query ;
...
void MainWindow::statistiques(QString table,QString critere,int valeur1,int valeur2,QString unite)
{
...
void MainWindow::on_par_capacite_clicked()
{
...
void MainWindow::on_table_prix_activated(const QModelIndex &index)
...
void MainWindow::on_table_periode_activated(const QModelIndex &index)
{
    QSqlQuery query ;
